...
import in.mitul.cloudshareapi.dto.ProfileDTO;
import in.mitul.cloudshareapi.repository.ProfileRepository;
...
public class ProfileService {
    ...
    public ProfileDocument getCurrentProfile() {
        ...
        if (profile == null) {
            ...
            System.out.println("Profile not found for clerkId: " + clerkId + ". Creating new profile...");
